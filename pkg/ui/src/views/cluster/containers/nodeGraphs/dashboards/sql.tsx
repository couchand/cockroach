...
export default function (props: GraphDashboardProps) {
  ...
  function default_aggregate(name: string, title: string, nonNegativeRate?: boolean) {
    if (aggregationLevel === AggregationLevel.Cluster) {
      return (
        <Metric name={name} title={title} sources={nodeSources} nonNegativeRate={nonNegativeRate} />
      );
    }

    return nodeIDs.map((nid) => (
      <Metric name={name} title={nodeDisplayName(nodesSummary, nid)} sources={[nid]} />
    ));
  }
  ...
  charts.push(
    ...
    >
      <Axis label="errors">
        {default_aggregate("cr.node.sql.failure.count", "Errors")}
      </Axis>
    </LineGraph>,
  );
  ...
  charts.push(
    ...
    >
      <Axis label="queries">
        {default_aggregate("cr.node.sql.distsql.queries.active", "Active Queries", true /* nonNegativeRate */)}
      </Axis>
    </LineGraph>,
  );
  ...
  charts.push(
    ...
    >
      <Axis label="statements">
        {default_aggregate("cr.node.sql.ddl.count", "DDL Statements", true /* nonNegativeRRate */)}
      </Axis>
    </LineGraph>,
  );
