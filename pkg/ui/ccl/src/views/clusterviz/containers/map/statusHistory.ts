...
type Location = protos.cockroach.server.serverpb.LocationsResponse.Location$Properties;
...
export default class NodeStatusHistory {
    ...
    location(): [number, number] {
        return [this.loc.longitude, this.loc.latitude];
    }
