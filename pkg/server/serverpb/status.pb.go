...
type CommandQueueResponse struct {
	Snapshot cockroach_storage_storagepb.CommandQueuesSnapshot `protobuf:"bytes,1,opt,name=snapshot" json:"snapshot"`
}
...
type StmtExecution struct {
	...
	DistSQLUsed bool      `protobuf:"varint,3,opt,name=distSQLUsed,proto3" json:"distSQLUsed,omitempty"`
	OptUsed     bool      `protobuf:"varint,4,opt,name=optUsed,proto3" json:"optUsed,omitempty"`
	RetryCount  int64     `protobuf:"varint,5,opt,name=retry_count,json=retryCount,proto3" json:"retry_count,omitempty"`
	...
	ParseLat    float64   `protobuf:"fixed64,8,opt,name=parse_lat,json=parseLat,proto3" json:"parse_lat,omitempty"`
	PlanLat     float64   `protobuf:"fixed64,9,opt,name=plan_lat,json=planLat,proto3" json:"plan_lat,omitempty"`
	RunLat      float64   `protobuf:"fixed64,10,opt,name=run_lat,json=runLat,proto3" json:"run_lat,omitempty"`
	ServiceLat  float64   `protobuf:"fixed64,11,opt,name=service_lat,json=serviceLat,proto3" json:"service_lat,omitempty"`
	OverheadLat float64   `protobuf:"fixed64,12,opt,name=overhead_lat,json=overheadLat,proto3" json:"overhead_lat,omitempty"`
}

func (m *StmtExecution) Reset()                    { *m = StmtExecution{} }
func (m *StmtExecution) String() string            { return proto.CompactTextString(m) }
func (*StmtExecution) ProtoMessage()               {}
func (*StmtExecution) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{63} }

type TxnAttempt struct {
	StartTime  time.Time       `protobuf:"bytes,1,opt,name=start_time,json=startTime,stdtime" json:"start_time"`
	Statements []StmtExecution `protobuf:"bytes,2,rep,name=statements" json:"statements"`
}

func (m *TxnAttempt) Reset()                    { *m = TxnAttempt{} }
func (m *TxnAttempt) String() string            { return proto.CompactTextString(m) }
func (*TxnAttempt) ProtoMessage()               {}
func (*TxnAttempt) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{64} }
...
type TxnExecution struct {
	...
	Attempts  []TxnAttempt `protobuf:"bytes,4,rep,name=attempts" json:"attempts"`
}

func (m *TxnExecution) Reset()                    { *m = TxnExecution{} }
func (m *TxnExecution) String() string            { return proto.CompactTextString(m) }
func (*TxnExecution) ProtoMessage()               {}
func (*TxnExecution) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{65} }
...
func (*TransactionsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{66} }

type TransactionsResponse struct {
	Transactions []TxnExecution `protobuf:"bytes,1,rep,name=transactions" json:"transactions"`
}
...
func (*TransactionsResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{67} }
...
func init() {
	...
	proto.RegisterType((*StmtExecution)(nil), "cockroach.server.serverpb.StmtExecution")
	proto.RegisterType((*TxnAttempt)(nil), "cockroach.server.serverpb.TxnAttempt")
	proto.RegisterType((*TxnExecution)(nil), "cockroach.server.serverpb.TxnExecution")
	proto.RegisterType((*TransactionsRequest)(nil), "cockroach.server.serverpb.TransactionsRequest")
	proto.RegisterType((*TransactionsResponse)(nil), "cockroach.server.serverpb.TransactionsResponse")
...
func (c *statusClient) Transactions(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (*TransactionsResponse, error) {
	out := new(TransactionsResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/Transactions", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Status_Transactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransactionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).Transactions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/Transactions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).Transactions(ctx, req.(*TransactionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Status_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Status_Transactions_Handler,
		},
	},
...
func (m *StmtExecution) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StmtExecution) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintStatus(dAtA, i, uint64(types.SizeOfStdTime(m.StartTime)))
	n48, err := types.StdTimeMarshalTo(m.StartTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n48
	...
	if m.RetryCount != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintStatus(dAtA, i, uint64(m.RetryCount))
	}
	if m.NumRows != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintStatus(dAtA, i, uint64(m.NumRows))
	}
	if len(m.Err) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Err)))
		i += copy(dAtA[i:], m.Err)
	}
	if m.ParseLat != 0 {
		dAtA[i] = 0x41
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ParseLat))))
		i += 8
	}
	if m.PlanLat != 0 {
		dAtA[i] = 0x49
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.PlanLat))))
		i += 8
	}
	if m.RunLat != 0 {
		dAtA[i] = 0x51
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.RunLat))))
		i += 8
	}
	if m.ServiceLat != 0 {
		dAtA[i] = 0x59
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ServiceLat))))
		i += 8
	}
	if m.OverheadLat != 0 {
		dAtA[i] = 0x61
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.OverheadLat))))
		i += 8
	}
	return i, nil
}

func (m *TxnAttempt) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TxnAttempt) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintStatus(dAtA, i, uint64(types.SizeOfStdTime(m.StartTime)))
	n49, err := types.StdTimeMarshalTo(m.StartTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n49
...
func (m *TxnExecution) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TxnExecution) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintStatus(dAtA, i, uint64(types.SizeOfStdTime(m.StartTime)))
	n50, err := types.StdTimeMarshalTo(m.StartTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n50
...
func (m *StmtExecution) Size() (n int) {
	var l int
	_ = l
	...
	if m.RetryCount != 0 {
		n += 1 + sovStatus(uint64(m.RetryCount))
	}
	if m.NumRows != 0 {
		n += 1 + sovStatus(uint64(m.NumRows))
	}
	l = len(m.Err)
	if l > 0 {
		n += 1 + l + sovStatus(uint64(l))
...
func (m *TxnExecution) Size() (n int) {
	var l int
	_ = l
	l = types.SizeOfStdTime(m.StartTime)
	n += 1 + l + sovStatus(uint64(l))
...
func (m *StmtExecution) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StmtExecution: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StmtExecution: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DistSQLUsed", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DistSQLUsed = bool(v != 0)
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OptUsed", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 8:
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.ParseLat = float64(math.Float64frombits(v))
		case 9:
			if wireType != 1 {
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.PlanLat = float64(math.Float64frombits(v))
		case 10:
			if wireType != 1 {
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.RunLat = float64(math.Float64frombits(v))
		case 11:
			if wireType != 1 {
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.ServiceLat = float64(math.Float64frombits(v))
		case 12:
			if wireType != 1 {
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.OverheadLat = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipStatus(dAtA[iNdEx:])
			if err != nil {
...
func (m *TxnAttempt) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxnAttempt: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxnAttempt: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Statements = append(m.Statements, StmtExecution{})
			if err := m.Statements[len(m.Statements)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *TxnExecution) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxnExecution: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxnExecution: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			m.Attempts = append(m.Attempts, TxnAttempt{})
...
func (m *TransactionsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Transactions = append(m.Transactions, TxnExecution{})
...
var fileDescriptorStatus = []byte{
	...
	,
}
